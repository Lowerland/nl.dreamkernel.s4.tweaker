...
public class DialogActivity extends Activity implements OnCheckedChangeListener {
	...
	public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
		if (isChecked) {
			...
			// finish();
			/*
			 * hide_dialog = 1; SharedPreferences sharedPreferences =
			 * getSharedPreferences("MY_SHARED_PREF", 0);
			 * SharedPreferences.Editor editor = sharedPreferences.edit();
			 * editor.putInt("hide_dialog", hide_dialog); editor.commit();
			 */
			...
			hidedialog = 0;
			/*
			 * hide_dialog = 0; Log.d(TAG,"isunChecked"+hide_dialog);
			 */
		}
	 ...
	 * stub finish(); Log.d(TAG,"onDialogOK pressed"); }
	 */
	...
	/*
	 * private OnClickListener mVioletListener = new OnClickListener() { public
	 * void onClick(View v) { // To send a result, simply call setResult()
	 * before your // activity is finished. setResult(RESULT_OK, (new
	 * Intent()).setAction("Violet!")); finish(); } };
	 */
}
