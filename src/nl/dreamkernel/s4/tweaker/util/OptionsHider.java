...
public class OptionsHider {
	...
	public static void MiscTweaksHider(Context context) {
		...
		Log.d(TAG, "OptionsHider() Dyn_File_Sys_SYNC_hide = "
				+ FileCheck.Dyn_File_Sys_SYNC_hide);
		if (FileCheck.Dyn_File_Sys_SYNC_hide == 1) {
	...
	public static void SoundTweaksHider(Context context) {
		...
		if (FileCheck.gpl_mic_hide == 1) {
			...
			SoundTweaks.textuncompatibel2
					.setText(R.string.disabled_option_text);
		}
